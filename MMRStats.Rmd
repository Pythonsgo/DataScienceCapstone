...
MMR1clean$years_0to9 <- rowMeans(MMR1clean[,c('2019', '2018','2017', '2016', '2015', '2014', '2013', '2012', '2011')], na.rm=TRUE)
 
MMR1clean$years_10to19 <- rowMeans(MMR1clean[,c('2010', '2009', '2008','2007', '2006', '2005', '2004', '2003', '2002', '2001')], na.rm=TRUE) 

MMR1clean$years_20to29 <- rowMeans(MMR1clean[,c('2000','1999', '1998','1997', '1996', '1995', '1994', '1993', '1992', '1991')], na.rm=TRUE)

MMR1clean$years_30to39 <- rowMeans(MMR1clean[,c('1990','1989', '1988','1987', '1986', '1985', '1984', '1983', '1982', '1981')], na.rm=TRUE)
 
MMR1clean$years_40 <- rowMeans(MMR1clean[,c('1980', '1980')], na.rm=TRUE)
...
MMR_age <- MMR1clean %>% select(country, starts_with("years"))
temp <-names(MMR_age)[2:6]

MMR_age[,temp]=round(MMR_age[,temp],1)
...
MMR_summary <- summary_table(MMR_age, our_summary1)
...
MMR_new_graph <- MMR_graph %>%
  pivot_longer(!country, names_to = "Age", values_to = "Coverage_MMR")
...
ggplot(test, aes(x=Age, y=Coverage_MMR, color=country)) + geom_point()

```

```{r graph2, eval=TRUE, echo=FALSE}

ggplot(MMR_new_graph, aes(x=Age, y=Coverage_MMR)) + geom_point()
